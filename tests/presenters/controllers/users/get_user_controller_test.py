...
def test_handler(get_user_controller, user_repository_spy, fake_user):
    ...
    response = get_user_controller.handler(param=param)
...
def test_handler_error_with_invalid_user_id(get_user_controller, fake_user):
    """
...
def test_handler_error_without_user_id_param(get_user_controller):
    """
    Testando o erro no metodo handler.
