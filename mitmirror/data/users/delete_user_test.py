"""Testes para a classe DeleteUser"""
from pytest import raises
from mitmirror.domain.models import User
from mitmirror.errors import DefaultError


def test_delete(delete_user_with_spy, user_repository_spy, fake_user):
    """
    Testando o metodo delete.
    Deve retornar uma mensagem de sucesso, e um usuario.
    """

    response = delete_user_with_spy.delete(user_id=fake_user.id)
...
def test_delete_error(delete_user_with_spy, user_repository_spy, fake_user):
    """
    ...
    response = delete_user_with_spy.delete(user_id=fake_user.name)
